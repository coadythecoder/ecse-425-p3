...
begin
    ...
    begin
        ...
        -- --------------------------------------------------------------------
        --check("x1",  << signal /testbench/uut/reg_file/registers(1)  : std_logic_vector(31 downto 0) >>,  5);
        --check("x2",  << signal /testbench/uut/reg_file/registers(2)  : std_logic_vector(31 downto 0) >>,  3);
        --check("x3",  << signal /testbench/uut/reg_file/registers(3)  : std_logic_vector(31 downto 0) >>,  8);
        --check("x4",  << signal /testbench/uut/reg_file/registers(4)  : std_logic_vector(31 downto 0) >>,  2);
        --check("x6",  << signal /testbench/uut/reg_file/registers(6)  : std_logic_vector(31 downto 0) >>, 10);
        --check("x7",  << signal /testbench/uut/reg_file/registers(7)  : std_logic_vector(31 downto 0) >>,  0);  -- beq skip
        --check("x8",  << signal /testbench/uut/reg_file/registers(8)  : std_logic_vector(31 downto 0) >>, 42);  -- beq taken
